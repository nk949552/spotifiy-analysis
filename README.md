...
and determine how they relate to **track popularity**.
...
### 2. Genre vs Popularity
Analyzed which genres have the highest average track popularity.

### 3. Danceability vs Popularity
Checked whether more danceable songs tend to be more popular.

### 4. Energy vs Danceability
Explored relationships between audio features.

### 5. Tempo vs Popularity
Investigated whether song speed impacts popularity.

### 6. Correlation Analysis
Used a heatmap to examine relationships between numerical features.
...
- Energy and danceability are moderately related.
- Tempo does not significantly affect track popularity.
...
- Create interactive dashboards (Power BI or Streamlit)
